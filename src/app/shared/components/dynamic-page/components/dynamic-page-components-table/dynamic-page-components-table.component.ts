...
import {DynamicPageComponentsPoput} from '../dynamic-page-components-poput/dynamic-page-components-poput.component'

@Component({
  selector: 'app-dynamic-page-components-table',
  imports: [CommonModule, FormsModule,DynamicPageComponentsPoput],
  templateUrl: './dynamic-page-components-table.component.html',

})
export class DynamicPageTableComponent {
