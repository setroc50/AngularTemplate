      ...
      <div class="mt-2 space-y-2" role="radiogroup" [attr.aria-labelledby]="config?.key + '-label'">
        ...
        >
          <input
            ...
            class="h-4 w-4 border-gray-300 rounded-full cursor-pointer
                   dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-offset-gray-800
                   text-red-600 focus:ring-red-500
                   dark:text-red-500 dark:focus:ring-red-500"
          />
          <label
